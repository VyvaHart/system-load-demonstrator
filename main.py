...
MY_CUSTOM_REQUESTS = Counter('my_custom_requests_v6', 'Total custom requests v6', ['path'])
...
def create_app():
    ...
    print(f"FACTORY_DEBUG: PrometheusMetrics.init_app(app) called.")
    metrics.info('my_app_info_factory', 'System Load App - Factory', version='1.0.3-factory')
